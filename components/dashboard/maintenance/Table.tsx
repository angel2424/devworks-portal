    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
        <div className="relative flex-1 min-w-0 w-full sm:max-w-xs">
          <Search
            className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-gray-400 pointer-events-none" size='1rem'
          />
          <Input
            ...
            {filtered.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  {plan.client?.name && (
                    <p className="text-xs text-gray-400 truncate mt-0.5">{plan.client?.name ?? "—"}</p>
                  )}
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <p className="text-xs text-brand-400 capitalize">
                      <span className="text-gray-400 uppercase font-medium">Inicio | </span>{formatDate(plan.start_date)}
                    </p>
                  </div>
                </button>
              );
      ...
      <div className="hidden md:block rounded-xl border border-gray-200 bg-white overflow-scroll">
        <Table>
          <TableHeader>
                  ...
                  >
                    ...
                    <TableCell className="pl-5 py-3.5">
                      <div className="flex items-center gap-4">
                        <div className="w-7 h-7 rounded-lg bg-brand-50 border border-amber-100 flex items-center justify-center shrink-0">
                         <Construction size={'1rem'} className="text-brand-500" />
                        </div>
                    ...
                    <TableCell className="py-3.5">
                      <span className="text-xs text-gray-500 capitalize">{formatDate(plan.start_date)}</span>
                    </TableCell>

                    <TableCell className="py-3.5 pr-5 capitalize">
