    ...
    return (
      <div className="relative">
        <button
          ...
          className="w-8 h-8 rounded-full bg-brand-100 border border-brand-200 flex items-center justify-center transition-colors hover:bg-brand-200"
        >
            ...
            <div className="absolute top-full right-0 mt-1.5 w-52 z-20 bg-white border border-gray-200 rounded-md shadow-lg overflow-hidden">
              ...
              <div className="p-1">
                <button
                  ...
                  disabled={signingOut}
                  className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {signingOut ? (
          ...
          <div className="absolute bottom-full left-0 right-0 mb-1 z-20 bg-white border border-gray-200 rounded-md shadow-lg overflow-hidden">
            ...
            <div className="p-1">
              <Link
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded transition-colors"
                onClick={() => setOpen(false)}
              >
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
